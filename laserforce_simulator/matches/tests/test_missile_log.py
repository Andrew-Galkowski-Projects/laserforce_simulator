"""Tests for the missile usage log (RES-03): the legacy missile event split into
``locking`` / ``missiled`` plus friendly-fire metadata and the legacy-literal
guard, together with the missile-log stats surface.
"""
